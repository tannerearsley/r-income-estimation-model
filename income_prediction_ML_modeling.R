...
#The darker blue, the more likely base value <=50k is true. The lighter, the more likely >50k is the case.
...
rpart.plot(income_dtree,type=1,extra=104,fallen.leaves=TRUE,box.palette = "Blues",main="Income Prediction Decision Tree")
